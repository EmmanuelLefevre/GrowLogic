...
-- Trigger to automatically update 'changedAt' on every row modification
...
CREATE TABLE growlogic.answer (
  ...
  "IdQuestion" UUID        NOT NULL UNIQUE,  -- UNIQUE: Only 1 answer allowed per question
  "IdUser"     UUID        NOT NULL,
...
--
-- Body (IdUser and IdPlant are auto-generated, do not send them):
-- {
--   "name": "Monstera",
--   "mood": "happy",
--   "AiContext": {}
